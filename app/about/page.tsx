...
export const metadata: Metadata = {
  ...
  description: "Learn about RemoteAIJobs - the premier platform for finding remote AI jobs",
};
...
const MILESTONES: Milestone[] = [
  {
    ...
    year: "2022",
    title: "Our Beginning",
    description: "RemoteAIJobs was founded with a mission to connect AI professionals with quality remote opportunities."
  },
  {
    id: "milestone-2",
    year: "2023",
    title: "1,000+ Placements",
    description: "We celebrated helping over 1,000 professionals find remote AI jobs across various industries."
  },
  {
    id: "milestone-3",
    year: "2024",
    title: "Global Expansion",
    description: "We expanded our reach to serve job seekers and companies from over 50 countries worldwide."
  },
  {
    id: "milestone-4",
    year: "2025",
    title: "Premium Services",
    description: "Launched our suite of premium services to help professionals advance their remote AI careers."
  },
];
